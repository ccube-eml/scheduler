...
class FilterTasksGenerator(TasksGenerator):
    """
    Generates the filter tasks.
    """

    def __init__(
            self,
            job_name,
            learner_outputs_number,
            dataset_name,
            training_rate,
            fusion_rate,
            class_attribute,
        ...
        :param learner_outputs_number: the total number of expected learner outputs.
        :type learner_outputs_number: int
        ...
        :param threshold: the threshold to apply the filter policy
        ...
        self.__learner_outputs_number = learner_outputs_number
    ...
    def __next__(self):
        if self.__i < 1:
            task = {
                ...
                'learner_outputs_number': self.__learner_outputs_number,
    ...
    def __next_predict_parameters(self):
        """
        Returns the next executor parameters.
